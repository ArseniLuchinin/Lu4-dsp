...
public:
  ...
  virtual bool execute(cufftHandle plan, size_t fftSize, size_t hopSize,
                       size_t overlapSize, bool isFirstRun, int batchCount) = 0;
...
public:
  ...
  bool execute(cufftHandle plan, size_t fftSize, size_t hopSize,
               size_t overlapSize, bool isFirstRun, int batchCount) override;
