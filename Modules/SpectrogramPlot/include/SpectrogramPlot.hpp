...
bool renderSpectrogramImageCuda(const float *input, unsigned char *outputBgr,
                                size_t rows, size_t cols, size_t colOffset,
                                size_t inputCols, float minValue,
                                float maxValue, bool hasMaskBelowDb,
                                float maskBelowDb,
