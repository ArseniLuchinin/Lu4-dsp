...
bool checkGPU() {
    ...
    std::cout << "Total global memory: " << totalMemory / (1024.0 * 1024.0) << " MB" << std::endl;
    std::cout << "Free global memory: " << freeMemory / (1024.0 * 1024.0) << " MB" << std::endl;
    std::cout << "Memory in use: " << (totalMemory - freeMemory) / (1024.0 * 1024.0) << " MB" << std::endl;
    std::cout << "Multiprocessors count: " << deviceProp.multiProcessorCount << std::endl;
